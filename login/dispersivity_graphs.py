...
def dispersivity_graphs():
    df = pd.read_csv('login/static/fig1_plots.csv', sep=";", na_filter=True)
    ...
    plt.savefig("login/static/DispersivityPlots/ticks")
    plt.clf()

    # subplot 2
    df2 = pd.read_csv('login/static/fig1_plots.csv', sep=";", na_filter=True)
    ...
    plt.tight_layout()
    plt.savefig("login/static/DispersivityPlots/box")
    plt.clf()

    # subplot 3
    df3 = pd.read_csv('login/static/fig1_plots.csv', sep=";", na_filter=True)
    ...
    plt.ylim((0, 0.001))
    plt.savefig("login/static/DispersivityPlots/scatter")
    plt.clf()
    dfs4 = pd.read_csv('login/static/fig1_plots.csv', delimiter=";")  # importing data for plot 2
