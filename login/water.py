...
from login.dispersivity_graphs import dispersivity_graphs
from login.file_checkers import allowed_file, check_file_for_liedl_equation, check_file_for_chu_equation, \
...
from login.form import RegistrationForm, LoginForm, UpdateAccountForm, LiedlForm, ChuForm, HamForm, Liedl3DForm, \
    BirlaForm, MaierGrathwohlForm, UserDatabaseForm, NumericalForm
from login.liedl3D import create_liedl3DPlot
from login.models import User, Liedl, Chu, Ham, Liedl3D, Birla, MaierGrathwohl, User_Database
from login.parameters import *
from login.scatterplot import create_scatterplot
from login.scatterplotAnalyticalModel import create_liedlPlotMultiple, create_chuEtAlPlotMultiple, \
